...
# from persona.prompt_template.gpt_structure import get_embedding_v2
...
#     importance_out = dict()
#     for count, node in enumerate(nodes):
#         importance_out[node.node_id] = node.importance_score
...
#     """
#     focal_embedding = get_embedding_v2(focal_pt)

#     relevance_out = dict()
#     for count, node in enumerate(nodes):
#         node_embedding = persona.associativeMemory.get_node_embedding(node.node_id)
...
#         nodes = [
#             [i.created, i]
#             for i in persona.associativeMemory.event_id_to_node.values()
#             #   + persona.associativeMemory.seq_thought
...
#         master_nodes = [
#             persona.associativeMemory.id_to_node[key]
